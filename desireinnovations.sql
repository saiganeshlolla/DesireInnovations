...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 24, 2023 at 10:21 AM
...
--
-- Database: `desireinnovations`
--

-- --------------------------------------------------------

--
-- Table structure for table `populationanalysis`
--

CREATE TABLE `populationanalysis` (
  `IndicatorNo` int(11) NOT NULL,
...
--
-- Dumping data for table `populationanalysis`
--

INSERT INTO `populationanalysis` (`IndicatorNo`, `Topic`, `Indicator`, `IndicatorName`, `Unit`) VALUES
(0, 'Topic', 'Indicator', 'IndicatorName', 'Unit'),
